          ...
          <table className="w-full border-collapse">
            <tbody>
              {unified.map((line, index) => (
                <tr
                  // biome-ignore lint/suspicious/noArrayIndexKey: duplicate diff lines need their ordered occurrence in the key
        ...
        <tbody>
          {lines.map((line, index) => {
            if (!line) {
              return (
                <tr
                  // biome-ignore lint/suspicious/noArrayIndexKey: empty split rows are ordered placeholders
