            ...
            <div className="relative">
              ...
              <div className="pointer-events-none absolute inset-0 flex items-center justify-center pb-4">
                ...
                <Button
                  ...
                  size="sm"
                  variant="outline"
                  className="pointer-events-auto relative z-10 rounded-lg bg-background text-foreground shadow-none hover:bg-muted dark:bg-background dark:text-foreground dark:hover:bg-muted"
                  onClick={() => {
...
function DirectionProviderWrapper({
  ...
  return (
    <div data-preview-base={base} dir={dir}>
      {children}
    </div>
  )
}
